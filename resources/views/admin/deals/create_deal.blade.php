                    ...
                    <form action="{{ route('deals.store') }}" method="POST" enctype="multipart/form-data">
                        <div class="row " style="margin-top: 6rem"> 
                                ...
                                <div class="pull-right ">
                                    <a class="btn1 btn-primary1" href="{{route('deals.index')}}" style="margin-left: 20px;position: absolute;left:65%; top:12%; outline: none;text-decoration: none;"> Back</a>
                                </div>
                        </div>
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <h3><label for="name">Deal Name: </label></h3><br>
                            <input type="text" name="name" id="name">
                            @error('name')
                                <span style="color: red; width:100%;">{{$message}}</span>
                            @enderror
                            <h3><label for="description">Deal Detail: </label></h3><br>
